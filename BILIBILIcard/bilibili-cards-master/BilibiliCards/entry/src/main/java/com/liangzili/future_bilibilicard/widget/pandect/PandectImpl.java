...
public class PandectImpl extends FormController {
    private static final HiLogLabel TAG = new HiLogLabel(HiLog.DEBUG, 0x0, PandectImpl.class.getName());
    private static final int DIMENSION_1X2 = 1;

    public PandectImpl(Context context, String formName, Integer dimension) {
    ...
    public void update(long formId){
        ...
        String url = "https://member.bilibili.com/x/web/data/pandect?type=1";
